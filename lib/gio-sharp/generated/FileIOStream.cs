...
#region Autogenerated code
	public class FileIOStream : IOStream, Seekable
	{
		...
		public string Etag { 
			get {
				var raw_ret = g_file_io_stream_get_etag(Handle);
		...
		public static new GLib.GType GType { 
			get {
				var raw_ret = g_file_io_stream_get_type();
		...
		public unsafe FileInfo QueryInfoFinish (AsyncResult result) {
			var error = IntPtr.Zero;
			var raw_ret = g_file_io_stream_query_info_finish(Handle, result == null ? IntPtr.Zero : result.Handle, out error);
			var ret = GLib.Object.GetObject (raw_ret) as FileInfo;
			if (error != IntPtr.Zero) throw new GLib.GException (error);
			return ret;
		}
