...
#region Autogenerated code
	public class MountOperation : GLib.Object {
		...
		public string Password {
			get  {
				var raw_ret = g_mount_operation_get_password(Handle);
		...
		public string Username {
			get  {
				var raw_ret = g_mount_operation_get_username(Handle);
				string ret = GLib.Marshaller.Utf8PtrToString (raw_ret);
				return ret;
			}
			set  {
		...
		public string Domain {
			get  {
				var raw_ret = g_mount_operation_get_domain(Handle);
				string ret = GLib.Marshaller.Utf8PtrToString (raw_ret);
				return ret;
			}
			set  {
		...
		public PasswordSave PasswordSave {
			get  {
				int raw_ret = g_mount_operation_get_password_save(Handle);
				var ret = (PasswordSave) raw_ret;
				return ret;
			}
			set  {
		...
		{
			try {
				var op_managed = GLib.Object.GetObject (op, false) as MountOperation;
		...
		[GLib.DefaultSignalHandler(Type=typeof(MountOperation), ConnectionMethod="OverrideAborted")]
		...
		static void reply_cb (IntPtr op, int result)
		{
			try {
				var op_managed = GLib.Object.GetObject (op, false) as MountOperation;
				op_managed.OnReply ((MountOperationResult) result);
			} catch (Exception e) {
				GLib.ExceptionManager.RaiseUnhandledException (e, false);
			}
		}
		...
		[GLib.DefaultSignalHandler(Type=typeof(MountOperation), ConnectionMethod="OverrideReply")]
		protected virtual void OnReply (MountOperationResult result)
		{
			GLib.Value ret = GLib.Value.Empty;
		...
		[GLib.Signal("reply")]
		public event ReplyHandler Reply {
			add {
				GLib.Signal sig = GLib.Signal.Lookup (this, "reply", typeof (ReplyArgs));
				sig.AddDelegate (value);
			}
			remove {
				GLib.Signal sig = GLib.Signal.Lookup (this, "reply", typeof (ReplyArgs));
		...
		static void askpassword_cb (IntPtr op, IntPtr message, IntPtr default_user, IntPtr default_domain, int flags)
		{
			try {
				var op_managed = GLib.Object.GetObject (op, false) as MountOperation;
				op_managed.OnAskPassword (GLib.Marshaller.Utf8PtrToString (message), GLib.Marshaller.Utf8PtrToString (default_user), GLib.Marshaller.Utf8PtrToString (default_domain), (AskPasswordFlags) flags);
			} catch (Exception e) {
				GLib.ExceptionManager.RaiseUnhandledException (e, false);
			}
		}
		...
		[GLib.DefaultSignalHandler(Type=typeof(MountOperation), ConnectionMethod="OverrideAskPassword")]
		protected virtual void OnAskPassword (string message, string default_user, string default_domain, AskPasswordFlags flags)
		{
			GLib.Value ret = GLib.Value.Empty;
			var inst_and_params = new GLib.ValueArray (5);
		...
		public event AskPasswordHandler AskPassword {
			add {
				GLib.Signal sig = GLib.Signal.Lookup (this, "ask-password", typeof (AskPasswordArgs));
				sig.AddDelegate (value);
			}
			remove {
				GLib.Signal sig = GLib.Signal.Lookup (this, "ask-password", typeof (AskPasswordArgs));
		...
		[GLib.DefaultSignalHandler(Type=typeof(MountOperation), ConnectionMethod="OverrideAskQuestion")]
		protected virtual void OnAskQuestion (string message, string[] choices)
		{
			GLib.Value ret = GLib.Value.Empty;
			var inst_and_params = new GLib.ValueArray (3);
		...
		public event AskQuestionHandler AskQuestion {
			add {
				GLib.Signal sig = GLib.Signal.Lookup (this, "ask-question", typeof (AskQuestionArgs));
				sig.AddDelegate (value);
			}
			remove {
				GLib.Signal sig = GLib.Signal.Lookup (this, "ask-question", typeof (AskQuestionArgs));
		...
		[GLib.DefaultSignalHandler(Type=typeof(MountOperation), ConnectionMethod="OverrideShowProcesses")]
		...
		public event ShowProcessesHandler ShowProcesses {
			add {
				GLib.Signal sig = GLib.Signal.Lookup (this, "show-processes", typeof (ShowProcessesArgs));
				sig.AddDelegate (value);
			}
			remove {
				GLib.Signal sig = GLib.Signal.Lookup (this, "show-processes", typeof (ShowProcessesArgs));
		...
		public static new GLib.GType GType { 
			get {
				var raw_ret = g_mount_operation_get_type();
