...
delegate void AsyncReadyCallbackNative(IntPtr source_object, IntPtr res, IntPtr user_data);

	class AsyncReadyCallbackInvoker {
		readonly AsyncReadyCallbackNative native_cb;
	...
	class AsyncReadyCallbackWrapper {
		...
		readonly GLib.AsyncReadyCallback managed;
		...
		public static GLib.AsyncReadyCallback GetManagedDelegate (AsyncReadyCallbackNative native)
		{
			if (native == null)
				return null;
			var wrapper = (AsyncReadyCallbackWrapper) native.Target;
			if (wrapper == null)
				return null;
