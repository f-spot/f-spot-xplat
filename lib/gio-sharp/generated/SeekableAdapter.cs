...
#region Autogenerated code
	public class SeekableAdapter : GLib.GInterfaceAdapter, Seekable
	{
		...
		static bool SeekCallback (IntPtr seekable, long offset, GLib.SeekType type, IntPtr cancellable, out IntPtr error)
		{
			...
			try {
				var __obj = GLib.Object.GetObject (seekable, false) as SeekableImplementor;
				bool __result = __obj.Seek (offset, type, GLib.Object.GetObject (cancellable) as Cancellable);
				return __result;
			} catch (Exception e) {
		...
		{
			var native_iface = (SeekableIface) Marshal.PtrToStructure (ifaceptr, typeof (SeekableIface));
		...
		static GLib.GType _gtype = new GLib.GType (g_seekable_get_type ());
        ...
        public SeekableImplementor Implementor { get; }
