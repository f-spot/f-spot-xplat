...
#region Autogenerated code
	public class FileInputStream : InputStream, Seekable
	{
		...
		public unsafe FileInfo QueryInfo (string attributes, Cancellable cancellable) {
			...
			var raw_ret = g_file_input_stream_query_info(Handle, native_attributes, cancellable == null ? IntPtr.Zero : cancellable.Handle, out error);
		...
		public static new GLib.GType GType { 
			get {
				var raw_ret = g_file_input_stream_get_type();
		...
		public unsafe FileInfo QueryInfoFinish (AsyncResult result) {
			var error = IntPtr.Zero;
			var raw_ret = g_file_input_stream_query_info_finish(Handle, result == null ? IntPtr.Zero : result.Handle, out error);
			var ret = GLib.Object.GetObject (raw_ret) as FileInfo;
			if (error != IntPtr.Zero) throw new GLib.GException (error);
			return ret;
		}
