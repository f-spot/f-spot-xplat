...
#region Autogenerated code
	public class Cancellable : GLib.Object {
		...
		{
			try {
				var cancellable_managed = GLib.Object.GetObject (cancellable, false) as Cancellable;
		...
		[GLib.DefaultSignalHandler(Type=typeof(Cancellable), ConnectionMethod="OverrideCancelled")]
		...
		public static new GLib.GType GType { 
			get {
				var raw_ret = g_cancellable_get_type();
		...
		public static Cancellable Current { 
			get {
				var raw_ret = g_cancellable_get_current();
				var ret = GLib.Object.GetObject (raw_ret) as Cancellable;
				return ret;
			}
		}
