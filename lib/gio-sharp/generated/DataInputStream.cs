...
#region Autogenerated code
	public class DataInputStream : BufferedInputStream
	{
		...
		public DataInputStream (InputStream base_stream) : base (IntPtr.Zero)
		{
		...
		public DataStreamNewlineType NewlineType {
			get  {
				int raw_ret = g_data_input_stream_get_newline_type(Handle);
				var ret = (DataStreamNewlineType) raw_ret;
				return ret;
			}
			set  {
		...
		public unsafe string ReadUntilFinish(AsyncResult result, out ulong length) {
			UIntPtr native_length;
			var error = IntPtr.Zero;
			var raw_ret = g_data_input_stream_read_until_finish(Handle, result == null ? IntPtr.Zero : result.Handle, out native_length, out error);
		...
		public unsafe ushort ReadUint16(Cancellable cancellable) {
			var error = IntPtr.Zero;
		...
		public unsafe int ReadInt32(Cancellable cancellable) {
			var error = IntPtr.Zero;
		...
		public unsafe long ReadInt64(Cancellable cancellable) {
			var error = IntPtr.Zero;
		...
		public unsafe uint ReadUint32(Cancellable cancellable) {
			var error = IntPtr.Zero;
		...
		public static new GLib.GType GType { 
			get {
				var raw_ret = g_data_input_stream_get_type();
		...
		public unsafe string ReadLineFinish(AsyncResult result, out ulong length) {
			UIntPtr native_length;
			var error = IntPtr.Zero;
			var raw_ret = g_data_input_stream_read_line_finish(Handle, result == null ? IntPtr.Zero : result.Handle, out native_length, out error);
			string ret = GLib.Marshaller.PtrToStringGFree(raw_ret);
			length = (ulong) native_length;
			if (error != IntPtr.Zero) throw new GLib.GException (error);
			return ret;
