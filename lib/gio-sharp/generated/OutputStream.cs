...
#region Autogenerated code
	public class OutputStream : GLib.Object {
		...
		public unsafe long SpliceFinish(AsyncResult result) {
			var error = IntPtr.Zero;
			var raw_ret = g_output_stream_splice_finish(Handle, result == null ? IntPtr.Zero : result.Handle, out error);
		...
		public unsafe bool FlushFinish(AsyncResult result) {
			var error = IntPtr.Zero;
		...
		public unsafe long Write(byte[] buffer, ulong count, Cancellable cancellable) {
			var error = IntPtr.Zero;
			var raw_ret = g_output_stream_write(Handle, buffer, new UIntPtr (count), cancellable == null ? IntPtr.Zero : cancellable.Handle, out error);
			long ret = (long) raw_ret;
			if (error != IntPtr.Zero) throw new GLib.GException (error);
			return ret;
		}
		...
		public unsafe long WriteFinish(AsyncResult result) {
			var error = IntPtr.Zero;
			var raw_ret = g_output_stream_write_finish(Handle, result == null ? IntPtr.Zero : result.Handle, out error);
			long ret = (long) raw_ret;
			if (error != IntPtr.Zero) throw new GLib.GException (error);
			return ret;
		}
		...
		public unsafe bool Flush(Cancellable cancellable) {
			var error = IntPtr.Zero;
		...
		public void WriteAsync(byte[] buffer, ulong count, int io_priority, Cancellable cancellable, AsyncReadyCallback cb) {
			var cb_wrapper = new GLibSharp.AsyncReadyCallbackWrapper (cb);
			cb_wrapper.PersistUntilCalled ();
		...
		public static new GLib.GType GType { 
			get {
				var raw_ret = g_output_stream_get_type();
		...
		public void FlushAsync(int io_priority, Cancellable cancellable, AsyncReadyCallback cb) {
			var cb_wrapper = new GLibSharp.AsyncReadyCallbackWrapper (cb);
			cb_wrapper.PersistUntilCalled ();
		...
		public unsafe bool WriteAll(byte[] buffer, ulong count, out ulong bytes_written, Cancellable cancellable) {
