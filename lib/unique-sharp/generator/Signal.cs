...
namespace GtkSharp.Generation {
	...
	public class Signal {
		...
		readonly ReturnValue retval;
		readonly Parameters parms;
		readonly ClassBase container_type;
		...
		string DelegateName {
			get { return Name + "SignalDelegate"; }
                ...
                string EventHandlerQualifiedName {
                        get {
                                if (IsEventHandler)
		...
		string ReturnGType {
			get {
				var igen = SymbolTable.Table [retval.CType];
		...
		bool NeedNew (ClassBase implementor)
		{
		...
		public void GenEventHandler (GenerationInfo gen_info)
		{
			...
			var sw = gen_info.OpenStream (EventHandlerName);
		...
		void GenVMDeclaration (StreamWriter sw, ClassBase implementor)
		{
			var vmsig = new VMSignature (parms);
		...
		void GenGlueVirtualMethod (GenerationInfo gen_info)
		{
			var glue = gen_info.GlueWriter;
		...
		void GenChainVirtualMethod (StreamWriter sw, ClassBase implementor)
		{
		...
		void GenDefaultHandlerDelegate (GenerationInfo gen_info, ClassBase implementor)
		{
			var sw = gen_info.Writer;
			StreamWriter glue;
